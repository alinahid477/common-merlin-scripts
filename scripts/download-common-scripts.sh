...
scripts=("returnOrexit.sh" "contains-element.sh" "extract-and-take-input.sh" "install-tanzu-cli.sh" "init-prechecks.sh" "bastion_host_util.sh" "parse_yaml.sh" "select-from-available-options.sh" "tanzu_connect.sh")
