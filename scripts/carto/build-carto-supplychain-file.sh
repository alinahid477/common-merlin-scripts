...
function buildCartoSupplyChainFile () {
    ...
    local outputLocation=$2 # REQUIRED. A file containing the location/path of the generated values file. eg: file /tmp/vlocation containing this line "$HOME/configs/carto/values.templates.yaml"
